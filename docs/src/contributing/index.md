...
### Report Bugs
Found a bug? [Open an issue](https://github.com/Checkref-co/opencomplai/issues/new?template=bug_report.md) with:
...
### Suggest Features
Have an idea? [Open a discussion](https://github.com/Checkref-co/opencomplai/discussions/new?category=ideas) or create an issue with:
...
- In [CONTRIBUTORS.md](https://github.com/Checkref-co/opencomplai/blob/main/CONTRIBUTORS.md)
- In release notes
- On our website
...
### Questions?
- [GitHub Discussions](https://github.com/Checkref-co/opencomplai/discussions)
- Check [Development Setup](development-setup.md)
- Email: open@checkref.co

### Issues?
- Search [existing issues](https://github.com/Checkref-co/opencomplai/issues)
- Check [Troubleshooting](../troubleshooting/index.md)
- Ask in [Discussions](https://github.com/Checkref-co/opencomplai/discussions)
